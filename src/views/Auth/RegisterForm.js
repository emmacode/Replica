...
export const RegisterForm = (props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      // Should be done at the backend
      const findUsernames = users.find(
        (findUsername) => findUsername.username === username
      );
      const findEmails = users.find((findEmail) => findEmail.email === email);
      ...
      <Dialog open={props.signupModal}>
        <div className="field">
          <div className="authField">
            <DialogActions>
              <Button onClick={props.handleSignupClose} sx={{ color: "#fff" }}>
                <CloseIcon />
              </Button>
            </DialogActions>
            <div className="p-12">
